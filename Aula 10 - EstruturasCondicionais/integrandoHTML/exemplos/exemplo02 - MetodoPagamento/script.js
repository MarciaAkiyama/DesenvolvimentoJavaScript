function mostrarResultado(){
    ...
    if (metodoPagamento === "1"){
        ...
        resultado.innerHTML = "O valor da sua compra ficou R$ " + valorFinal.toFixed(2).replace("." , ",")
    } else {
        resultado.innerHTML = "O valor da sua compra ficou R$ " + valorGasto.toFixed(2).replace("." , ",")
    }
}